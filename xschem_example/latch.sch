...
N 320 -80 320 140 {
lab=OUT}
C {xschem_example/inv.sym} 140 -40 0 0 {name=X_inv1}
C {xschem_example/tinv.sym} -140 -40 0 0 {name=X_tinv1}
C {xschem_example/tinv_small.sym} 220 180 0 1 {name=X_tinv_small1}
