...
# Uncomment for BAG export
   laygo2.interface.magic.export(lib, filename=ref_dir_MAG_exported +libname+'_'+cellname+'.tcl', cellname=None, libpath='/WORK/hjpark/laygo2_workspace_sky130', scale=1, reset_library=False, tech_library='sky130A')
