...
# 3. Create istances.
   ...
   inv0 = tlib['inv_'+str(nf)+'x'].generate(name='inv0', netname = {'I':"CLK",'O':'net1','VSS':'VSS','VDD':'VDD'})
   inv1 = tlib['inv_'+str(nf)+'x'].generate(name='inv1', netname = {'I':"net1",'O':'Net2','VSS':'VSS','VDD':'VDD'})
   inv2 = tlib['inv_'+str(nf)+'x'].generate(name='inv2', netname = {'I':"Net3",'O':'Net4','VSS':'VSS','VDD':'VDD'})
   inv3 = tlib['inv_'+str(nf)+'x'].generate(name='inv3', netname = {'I':"Net5",'O':'O','VSS':'VSS','VDD':'VDD'}) 

   tinv0 = tlib['tinv_'+str(nf)+'x'].generate(name='tinv0',netname= {'I':'I','O':'Net3','EN':'net1','ENB':'Net2','VSS':'VSS','VDD':'VDD'})
   tinv1 = tlib['tinv_'+str(nf)+'x'].generate(name='tinv1',netname={'I':'Net4','O':'Net5','EN':'Net2','ENB':'net1','VSS':'VSS','VDD':'VDD'})

   tinv_small0 = tlib['tinv_small_1x'].generate(name='tinv_small0',netname={'I':'Net4','O':'Net3','EN':'Net2','ENB':'net1','VSS':'VSS','VDD':'VDD'})
   tinv_small1 = tlib['tinv_small_1x'].generate(name='tinv_small1',netname={'O':'Net5','EN':'net1','ENB':'Net2','I':'O','VSS':'VSS','VDD':'VDD'})
...
# 4. Place instances.
   ...
   mn_list.append(r23.mn(tinv0.pins['ENB'])[0])
   mn_list.append(r23.mn(tinv1.pins['EN'])[0])
   mn_list.append(r23.mn(tinv_small0.pins['EN'])[0])
   mn_list.append(r23.mn(tinv_small1.pins['ENB'])[0])
   dsn.route_via_track(grid=r23, mn=mn_list, track=_track,netname='Net2')
   ...
   dsn.route_via_track(grid=r23, mn=mn_list, track=_track, netname='O')
   ...
   dsn.route_via_track(grid=r23, mn=mn_list, track=_track, netname='Net4')
