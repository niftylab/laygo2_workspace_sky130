...
N -110 -340 1010 -340 {
lab=EN}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 170 -630 1 0 {name=X_inv7 NF=4}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 520 -630 1 0 {name=X_inv8 NF=4}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 880 -630 1 0 {name=X_inv9 NF=4}
...
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 -360 0 0 {name=x_AndF1 NF=2}
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 -170 0 0 {name=x_AndF2 NF=2}
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 30 0 0 {name=x_AndF3 NF=2}
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 220 0 0 {name=x_AndF4 NF=2}
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 410 0 0 {name=x_AndF5 NF=2}
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 580 0 0 {name=x_AndF6 NF=2}
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 760 0 0 {name=x_AndF7 NF=2}
C {xschem_lib/DFFRAM_full_custom/and_4in.sym} 1090 940 0 0 {name=x_AndF8 NF=2}
