...
N -310 -290 -310 -100 {}
N -440 90 70 90 {}
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 -260 0 0 {name=X_nand1}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 240 -250 0 0 {name=X_inv1 NF=2}
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 -70 0 0 {name=X_nand2}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 240 -60 0 0 {name=X_inv3 NF=2}
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 120 0 0 {name=X_nand3}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 240 130 0 0 {name=X_inv4 NF=2}
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 310 0 0 {name=X_nand5}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 240 320 0 0 {name=X_inv6 NF=2}
C {xschem_lib/DFFRAM_full_custom/inv.sym} -80 -560 1 0 {name=X_inv2 NF=2}
C {xschem_lib/DFFRAM_full_custom/inv.sym} -350 -560 1 0 {name=X_inv5 NF=2}
