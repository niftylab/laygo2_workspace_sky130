...
C {devices/opin.sym} 150 -20 0 0 {name=p1 lab=Y}
C {devices/ipin.sym} -120 0 0 0 {name=p2 lab=A}
C {devices/iopin.sym} 20 -110 3 0 {name=p3 lab=VDD}
C {devices/iopin.sym} 80 180 1 0 {name=p4 lab=VSS}
C {devices/ipin.sym} -120 100 0 0 {name=p5 lab=B}
