...
buf_clk = tlogic_prim['buffer_'+str(24)+'x'].generate(name='buf_clk')
...
for i in range(8):
    buf_sel.append(tlogic_prim['buffer_'+str(24)+'x'].generate(name='buf_sel'+str(i)))
...
mn_ref[0] = mn_ref[0] + byte_width*2
dsn.place(grid=pg, inst=buf_we[2], mn=mn_ref)
mn_ref[0] = mn_ref[0] + byte_width
