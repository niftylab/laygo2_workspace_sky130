...
nand = tlogic_prim['nand_'+str(nf_inv)+'x'].generate(name='nand')
...
dsn.place(grid=pg, inst=tap0, mn=pg.mn.bottom_right(buf_re1))
...
rvss1 = Rect(xy = [pg.abs2phy(pg.mn.bottom_left(tap0)-[0,1]), pg.abs2phy(pg.mn.top_right(tap0)+[0,1])], layer=['metal3','drwaing'])
dsn.append(rvss1)
# dsn.via(grid=r23, mn=r23.mn.bottom_left(tap0))
dsn.via(grid=r23, mn=r23.mn.bottom_left(tap0)+[1,0])
# dsn.via(grid=r23, mn=r23.mn.bottom_left(tap0)+[2,0])
rvss2 = Rect(xy = [pg.abs2phy(pg.mn.bottom_left(tap2)-[0,1]), pg.abs2phy(pg.mn.top_right(tap2)+[0,1])], layer=['metal3','drawing'])
dsn.append(rvss2)
# dsn.via(grid=r23, mn=r23.mn.bottom_left(tap2))
dsn.via(grid=r23, mn=r23.mn.bottom_left(tap2)+[1,0])
# dsn.via(grid=r23, mn=r23.mn.bottom_left(tap2)+[2,0])
# VDD
...
dsn.append(rvdd1)
# dsn.via(grid=r23, mn=r23.mn.top_left(tap1))
dsn.via(grid=r23, mn=r23.mn.top_left(tap1)+[1,0])
# dsn.via(grid=r23, mn=r23.mn.top_left(tap1)+[2,0])
# 6. Create pins.
...
pvss0 = dsn.pin(name='VSS0', grid=r45, mn=r45.mn.bbox(rvss1), direction='vertical')
pvss1 = dsn.pin(name='VSS1', grid=r45, mn=r45.mn.bbox(rvss2), direction='vertical')
pvdd0 = dsn.pin(name='VDD', grid=r45, mn=r45.mn.bbox(rvdd1), direction='vertical')
