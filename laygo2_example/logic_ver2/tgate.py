...
for nf in nf_list:
   ...
   nspace0 = templates['nmos130_fast_space_1x'].generate(name='nspace0', shape=[2,1])
   pspace0 = templates['pmos130_fast_space_1x'].generate(name='pspace0', shape=[2,1], transform='MX')
