...
for nf in nf_list:
   ...
   tinv0 = tlib['tinv_'+str(nf)+'x'].generate(name='I0')
   tinv_small0 = tlib['tinv_small_1x'].generate(name='I1')
   inv0 = tlib['inv_'+str(nf)+'x'].generate(name='I2')
   ...
   print("Create wires")
   _mn = [r23.mn(tinv0.pins['ENB'])[0], r23.mn(tinv_small0.pins['EN'])[0]]
   _track = [None, r23.mn(tinv0.pins['ENB'])[0,1]+1]
   rclkb0 = dsn.route_via_track(grid=r23, mn=_mn, track=_track)
